...
function findType(extension: any) {
  return Object.entries(mimeTypes).find(type => type[1].includes(extension)) || [];
}

export function addType(mime: string, extensions: string) {
